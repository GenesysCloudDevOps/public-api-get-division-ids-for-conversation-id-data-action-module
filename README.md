A Terraform/CX as Code remote module for the following Genesys Cloud public API operation: Get Division IDs for Conversation ID
...
```hcl
module "data_action" {
    source             = "git::https://github.com/GenesysCloudDevOps/public-api-get-division-ids-for-conversation-id-data-action-module.git?ref=v1.0.0"
    action_name        = "Get Division IDs for Conversation ID"
